export default function HeroSection({posts}){
    return (
        <div className="grid grid-cols-5 grid-rows-4 gap-2 mx-auto p-2 w-[500px] font-notica cursor-pointer md:w-[700px]">
            <div className=" col-span-3 row-span-4 relative leading-9 group overflow-hidden">
            ...
            <div className=" col-span-2 row-span-2 relative leading-5 group overflow-hidden">
            ...
            <div className=" row-span-2 relative leading-4 group overflow-hidden">
            ...
            <div className=" row-span-1 relative leading-4 group overflow-hidden">
